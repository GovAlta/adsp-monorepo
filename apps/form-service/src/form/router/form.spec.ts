...
describe('form router', () => {
  ...
  describe('findDataRegisters', () => {
    ...
    it('can find data registers and map descriptions from configuration definitions', async () => {
      const req = {
        tenant: { id: tenantId },
      };
          ...
          data: {
            results: [
              ...
              },
              {
                ...
                name: 'fghj',
                latest: {
                  configuration: ['123', '234', '3434', 'hellow woorld 123'],
                },
              },
              {
                namespace: 'data-register',
      ...
      expect(axiosMock.get.mock.calls[0][0]).toContain('/configuration/platform/configuration-service');

      expect(axiosMock.get.mock.calls[1][0]).toContain('/configuration/data-register');
      ...
      expect(res.send).toHaveBeenCalledWith([
        ...
        },
        {
          ...
          namespace: 'data-register',
          description: 'asdf',
          entries: ['123', '234', '3434', 'hellow woorld 123'],
        },
        {
          name: 'hello',
          namespace: 'data-register',
    ...
    it('uses empty description when register definition is missing', async () => {
      const req = {
        tenant: { id: tenantId },
      };
    ...
    it('returns an empty array when configuration service returns no results', async () => {
      const req = {
        tenant: { id: tenantId },
      };
    ...
    it('calls next when configuration service request fails', async () => {
      const req = {
        tenant: { id: tenantId },
      };
