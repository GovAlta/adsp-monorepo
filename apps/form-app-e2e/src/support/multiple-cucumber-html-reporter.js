...
const cucumberJsonDir = __dirname + '/../../../../dist/cypress/apps/form-app-e2e/cucumber-json';
const cucumberReportFileMap = {};
const cucumberReportMap = {};
const jsonIndentLevel = 2;
const htmlReportDir = __dirname + '/../../../../dist/cypress/apps/form-app-e2e/report';
const screenshotsDir = __dirname + '/../../../../dist/cypress/apps/form-app-e2e/screenshots';
const snapshotDir = __dirname + '/../../../../dist/cypress/apps/form-app-e2e/snapshots';
