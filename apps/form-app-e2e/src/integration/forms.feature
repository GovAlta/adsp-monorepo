Feature: Form app
  ...
  @TEST_CS-3946 @REQ_CS-3812 @TEST_CS-4052 @REQ_CS-4016 @TEST_CS-3983 @REQ_CS-3881 @TEST_CS-4044 @REQ_CS-4015 @regression
  Scenario: As a form user, I can use a task list form
    ...
    And the user views task "1" of "personal Information" with "Not started" status
    And the user views task "2" of "additional Information" with "Not started" status
    And the user views "Summary" link on task list page
    ...
    And the user views task "1" of "personal Information" with "In progress" status
    When the user clicks "Personal Information" task on task list page
    And the user enters "Auto" in a text field labelled "First Name"
    And the user enters "Test" in a text field labelled "Last Name"
    And the user enters "1970-10-30" in a date picker labelled "Birthday"
    And the user enters "CA" in a dropdown labelled "Nationality"
    And the user clicks Next button on the form page
    Then the user views Step "2" of "2" on the form page
    When the user clicks "Back to application overview" link on the form page
    And the user views task "1" of "personal Information" with "Completed" status
    And the user views task "2" of "additional Information" with "In progress" status
