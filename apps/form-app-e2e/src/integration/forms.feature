Feature: Form app
  ...
  Scenario: As a form user, I can use basic controls in a form
    ...
    # And the user enters "12:30:00 AM" in a time picker labelled "Value b"
...
# And the user uploads a file of "fileA.pdf" for "file a"
# And the user uploads a file of "fileB.img" for "file b"
# And the user goes to review page
# Then the user views all basic control user data