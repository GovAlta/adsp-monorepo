...
export const FormsDefinitions = () => {
  ...
  const { definitions: totalDefinitions } = useSelector(formResultTotalsSelector);
  ...
  const clearFilters = () => {
    const criteria = {};
    dispatch(formActions.setDefinitionCriteria(criteria));
    dispatch(loadDefinitions({ criteria }));
  };
