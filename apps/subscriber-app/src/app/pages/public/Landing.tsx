    ...
    <>
      ...
      <Main>
        ...
        <Section>
          <Container vs={3} hs={1}>
            <Grid>
              ...
              <GridItem md={4}>{/* <img src={caseStudy} alt="" /> */}</GridItem>
            </Grid>
          </Container>
        </Section>
        ...
        <Section backgroundColor="#eee">
          <Container vs={3} hs={1}>
            <Grid>
              <GridItem md={3}>{/* <img src={puzzleIcon} height="200px" alt="Integration" /> */}</GridItem>
              <GridItem md={9}>
                <div>
        ...
        <Section backgroundColor="#eee">
          <Container vs={3} hs={1}>
            <Grid>
              ...
              <GridItem md={3}>{/* <img src={userGroup} alt="" height="200px" /> */}</GridItem>
            </Grid>
          </Container>
        </Section>
