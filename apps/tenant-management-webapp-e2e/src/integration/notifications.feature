...
Feature: Notifications
  ...
  Scenario: As a service owner, I can add/edit/delete Notification Types
    ...
    Then the user "views" the notification type card of "autotest-addNotificationType", "Anyone (Anonymous)", "yes"
    ...
    And the user clicks save button
    Then the user "views" the notification type card of "autotest-editNotificationType", "auto-test-role1, file-service-admin", "no"
