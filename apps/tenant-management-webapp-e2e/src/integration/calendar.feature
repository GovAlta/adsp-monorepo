...
Feature: Calendar
  ...
  Scenario: As a tenant admin, I can add, edit and delete calendar-events
    ...
    # Valid data
    When the user enters "autotest-addEvent", "autotest event desc", "yes", "no", "Today", "10:30 am", "Today", "10:30 pm" in Add event modal
    And the user clicks Save button in Add calendar event modal
