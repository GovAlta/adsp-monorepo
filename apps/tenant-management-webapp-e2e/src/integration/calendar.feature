...
Feature: Calendar
    ...
    @TEST_CS-330 @REQ_CS-580 @REQ_CS-1652 @REQ_CS-1709 @regression @prod
    ...
    @TEST_CS-2460 @TEST_CS-2459 @TEST_CS-2477 @TEST_CS-2478 @REQ_CS-1675 @REQ_CS-1653 @REQ_CS-1677 @REQ_CS-1676 @regression @prod
    ...
    Scenario: As a tenant admin, I can see core calendars, so I understand what calendars are available in the platform
        ...
        And the user views only view details action for core calendar records on Calendars page
        When the user clicks eye icon for "Form intake" core calendar
        Then the user views the calendar details modal for "Form intake"
        And the user views "autotest" tenant roles for read and modify in calendar details modal
    ...
    @TEST_CS-4120 @REQ_CS-3587 @regression @ignore @obsolete
