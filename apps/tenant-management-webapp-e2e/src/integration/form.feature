...
# When the user has selected a tag from the dropdown
# Then the form definition list shows only form definitions associated with the selected tag
# When the user has selected a tag from the dropdown which has more than 10 form definitions associated with the "ResourceTag"
# Then the user views only the first 10 form definitions displayed
# And the user views a "Load more" button
# When the user clicks the "Load more" button
# Then the user views next set of form definitions displayed
# When the user open and close the form editor
# And the user navigates away and back within the tenant admin
# Then the selected tag and filtered results is maintained