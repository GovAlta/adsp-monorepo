...
# When the user enters "autotest-stream", "autotest-stream-desc", select events "status-service:application-healthy, fileservice:file-deleted", select roles "auto-test-role1, auto-test-role2"
