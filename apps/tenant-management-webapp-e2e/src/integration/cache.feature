...
Feature: Calendar
  ...
  @TEST_CS-4059 @TEST_CS-4063 @TEST_CS-4083 @REQ_CS-3622 @REQ_CS-3623 @REQ_CS-3624
  Scenario: As a tenant admin, I can add, edit and delete a cache target
    ...
    # Valid data
    When the user enters "urn:ads:autotest:autotest-cache-test:ttl", "1200" in Add target modal
    Then the user views "https://autotest.com/ttl" as read-only value for Url field in Add target modal
    When the user clicks Save button in Add calendar modal
    Then the user "views" the target of "urn:ads:autotest:autotest-cache-test:ttl", "1200"
    # Edit
    When the user clicks "Edit" button for the target of "urn:ads:autotest:autotest-cache-test:ttl", "1200"
    ...
    Then the user views delete "target" confirmation modal for ""urn:ads:autotest:autotest-cache-test:ttl"
