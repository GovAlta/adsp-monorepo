...
Feature: Task
  ...
  Scenario: As a tenant admin, I can add and delete a task queue
    ...
    # Validate data
    When the user enters "autotest", "add-edit-delete-queue" in Add queue modal
    And the user clicks Save button in Add queue modal
    Then the user views Queue page for "autotest", "add-edit-delete-queue"
    ...
    Then the user "views" the queue of "autotest", "add-edit-delete-queue"
    # Edit and back
    When the user clicks "Edit" button for the queue of "autotest", "add-edit-delete-queue"
    Then the user views Queue page for "autotest", "add-edit-delete-queue"
    ...
    Then the user "views" the queue of "autotest", "add-edit-delete-queue"
    # Delete
    When the user clicks "Delete" button for the queue of "autotest", "add-edit-delete-queue"
    Then the user views delete "task queue" confirmation modal for "add-edit-delete-queue"
    When the user clicks Delete button in delete confirmation modal
    Then the user "should not view" the queue of "autotest", "add-edit-delete-queue"
