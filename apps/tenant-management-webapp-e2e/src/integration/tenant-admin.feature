...
Feature: Tenant admin
  ...
  Scenario: As a tenant admin, I should be able to see useful information on the landing page
    ...
    And the user views introductions and links for "Access", "Agent", "Cache", "Calendar", "Comment", "Configuration", "Directory", "Event", "Feedback", "File", "Form", "Notification", "PDF", "Script", "Status", "SharePoint", "Task", "Value"
    ...
    When the user selects the "Dashboard" menu item
    And the user clicks "SharePoint" link
    Then the user is directed to "SharePoint service" page
