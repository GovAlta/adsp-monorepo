...
const contentManagerApi = reviewWorkflowsApi.enhanceEndpoints({
    addTagTypes: [
...
export { useGetContentTypesQuery, useGetRecentlyAssignedDocumentsQuery, useGetStagesQuery, useUpdateAssigneeMutation, useUpdateStageMutation };
