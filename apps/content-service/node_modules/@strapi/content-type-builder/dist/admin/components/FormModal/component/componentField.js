...
const componentField = {
    ...
    radios: [
        {
            title: {
                id: getTrad.getTrad('form.attribute.component.option.create'),
                defaultMessage: 'Create a new component'
            },
            description: {
                id: getTrad.getTrad('form.attribute.component.option.create.description'),
        ...
        {
            title: {
                id: getTrad.getTrad('form.attribute.component.option.reuse-existing'),
                defaultMessage: 'Use an existing component'
            },
            description: {
                id: getTrad.getTrad('form.attribute.component.option.reuse-existing.description'),
...
//# sourceMappingURL=componentField.js.map
