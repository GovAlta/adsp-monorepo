import {
  ...
  FETCH_REF_DEFINITIONS_SUCCESS_ACTION,
  UPDATE_REF_DEFINITION_SUCCESS_ACTION,
...
export default function (state: FormState = defaultState, action: FormActionTypes): FormState {
  switch (action.type) {
    ...
    case FETCH_REF_DEFINITIONS_SUCCESS_ACTION:
      return {
        ...state,
        refs: action.payload,
      };

    case UPDATE_REF_DEFINITION_SUCCESS_ACTION:
      return {
        ...state,
        refs: {
          ...action.payload,
