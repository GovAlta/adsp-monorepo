        ...
        <div style={{display:'flex', flexDirection: 'row'}}>
          ...
          <div style={{flex: 1, flexDirection: 'column', width: '130px'}}>
            <div style={{flexDirection: 'row', backgroundColor: '#f1f1f1', height: '27px', marginTop: '-5px'}}>
              <div className="goa-socialconnect" style={{margin: '0px', textAlign: 'right'}}>
                <div>
                  {/* <a href={'https://github.com/abgov'} className="github">
            ...
            <div style={{display: 'flex', flexDirection: 'row', paddingTop: '16px'}}>
              <div style={{margin: '4px 6px 6px 0'}}><img src={person} alt="" height="26px" /></div>
              <Link to={url} style={{margin: '6px 20px 12px 0'}}>{urlName}</Link>
            </div>
          </div>
        </div>
      </header>
