...
import { OverflowWrap, EntryDetail, TableData } from '../styled-components';
...
export const FormDefinitionItem = ({ formDefinition, onDelete }: PdfTemplateItemProps): JSX.Element => {
  ...
  return (
    <>
      <tr>
        <TableData data-testid="form-definitions-name">
          <OverflowWrap>{formDefinition.name}</OverflowWrap>
        </TableData>
        <TableData data-testid="form-definitions-template-id">
          <OverflowWrap>{formDefinition.id}</OverflowWrap>
        </TableData>
        <TableData data-testid="form-definitions-description">
