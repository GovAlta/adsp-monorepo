...
import { GetAllTypeSubscriptions, UnsubscribeUserSubscription } from '@store/subscription/actions';
      ...
      {showDeleteConfirmation && (
        <DeleteModal
          ...
          onDelete={() => {
            ...
            dispatch(UnsubscribeUserSubscription({ data: { type: selectedType, data: selectedSubscription } }));
          }}
        />
      )}
    </CheckSubscriberRoles>
