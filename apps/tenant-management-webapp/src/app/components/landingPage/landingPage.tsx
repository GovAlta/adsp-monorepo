              ...
              <Grid>
                <GridItem md={7}>
                  ...
                  <p>
                    ...
                    Basically, we have done the heavy lifting so that you and your teams can focus on the specific
                    pieces unique to your project. Sound good? See for yourself how it’s helped other teams out.
                  </p>
                </GridItem>
                <GridItem md={4}>
            ...
            <Container vs={2} hs={1}>
              <Grid>
                <GridItem md={8}>
                  ...
                  <h3>Developers</h3>
                  <p>
                    Service management platform was designed with developers in mind, integrations are quick to setup
                    and configuration is easy.
                  </p>
                </GridItem>
                <GridItem md={3}>
