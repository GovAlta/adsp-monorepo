            ...
            <GridItem md={9}>
                ...
                <Container vs={2} hs={1}>
                  <Grid>
                    <GridItem md={7}>
                      ...
                      <p>
                        We understand that everyone is busy, and we also know that a lot of teams end up building the
                        same components. We want to save everyone time while providing a consistent and pleasant
                        experience for Albertans. Our goal is to speed teams up while allowing for incredible control
                        and immersion. Basically, we have done the heavy lifting so that you and your teams can focus on
                        the specific pieces unique to your project. Sound good? See for yourself how it’s helped other
                        teams out.
                      </p>
                    </GridItem>
                    <GridItem md={4}>
              ...
              <Section>
                <Container vs={2} hs={1}>
                  ...
                  <p>
                    Find out a bit more about our platform services and how they could help enhance your program
                    services
                  </p>
                ...
                <Container vs={2} hs={1}>
                  <Grid>
                    <GridItem md={8}>
                      ...
                      <p>
                        Setup and control the access and individual platform services through the fine grain control
                        over roles and permissions.
                      </p>
                      <h3>Staff</h3>
                      <p>
                        Empower staff who regularly post notices, and send messages by giving them the tools to craft
                        and manage their communications
                      </p>
                      <h3>Developers</h3>
                      <p>
                        Service management platform was designed with developers in mind, integrations are quick to
