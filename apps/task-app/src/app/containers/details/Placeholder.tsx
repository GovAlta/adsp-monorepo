import { GoabCallout, GoabDetails, GoabButtonGroup, GoabButton } from '@abgov/react-components';
...
const Placeholder: FunctionComponent<TaskDetailsProps> = ({
  ...
  return (
    <TaskDetailsLayout>
      <div>
        <GoabCallout type="information" heading="Task detail view">
        ...
        <GoabDetails ml="s" heading="Show task specific view">
        ...
        <GoabDetails ml="s" heading="Update task based on user actions">
