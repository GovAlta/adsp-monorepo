...
export const environment = {
  ...
  KEYCLOAK_CORE_TOKEN_URL:
    'https://access-dev.os99.gov.ab.ca/auth/realms/core/protocol/openid-connect/token',
  KEYCLOAK_CORE_AUTH_URL:
    'https://access-dev.os99.gov.ab.ca/auth/realms/core/protocol/openid-connect/auth',
