// clean-code-ignore: RULE-19 — schema data with no behaviour; the pages/id transform applied to it
// is covered by apps/sandbox-app/.../externalNavigationDefinition.spec.ts.
// The multi-page form template a tenant admin gets from "Add form". It lives here rather than in
// form-editor-common so that applications can use it without taking on that library's dependency
// on the tenant admin store.
export const defaultMultiPageFormSchema = {
  type: 'object',
  properties: {
    link: {},
    fullName: {
...
export const defaultMultiPageFormUiSchema = {
  type: 'Categorization',
  elements: [
    {
      type: 'Category',
...
export const defaultMultiPageFormData = {
  provideAddress: true,
  vegetarian: false,
};
