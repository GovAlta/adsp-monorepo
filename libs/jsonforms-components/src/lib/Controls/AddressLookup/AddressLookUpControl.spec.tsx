...
describe('AddressLookUpControl', () => {
  ...
  // it('should show an error if required field is empty on blur', () => {
  //   renderComponent();

  //   const addressInput = screen.getByPlaceholderText('Start typing the first line of your address');
  //   fireEvent.blur(addressInput);

  //   expect(screen.getByText('addressLine1 is required')).toBeInTheDocument();
  // });
});
