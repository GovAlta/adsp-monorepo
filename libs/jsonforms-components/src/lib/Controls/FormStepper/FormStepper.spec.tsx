...
describe('form stepper control', () => {
  ...
  const mockJsonFormContextValue = {
    data: new Map(), // Customize this based on your component's usage
    functions: new Map(), // Customize this based on your component's usage
    submitFunction: new Map([['submit-form', jest.fn()]]), // Customize this based on your component's usage
  };

  // Mock the context implementation
  jest.mock('../../Context', () => ({
    ...jest.requireActual('../../Context'), // Use the actual implementation for everything except JsonFormContext
    JsonFormContext: {
