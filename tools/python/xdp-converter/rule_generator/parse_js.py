...
from rule_generator.normalize_rules import (
    ElementRules,
    _collect_rules_from_script,
    _iter_all_scripts_with_owner,
...
def process_xdp_root_for_jsonforms_rules(
    ...
    return to_jsonforms_rules(root, rules_map, name_to_pointer)
